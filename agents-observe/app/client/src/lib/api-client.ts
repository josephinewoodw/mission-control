...
import type { Project, Session, RecentSession, ServerAgent, ParsedEvent, SessionUsage } from '@/types';
...
export const api = {
  ...
  getSessionUsage: (sessionId: string) =>
    fetchJson<SessionUsage | null>(`/sessions/${encodeURIComponent(sessionId)}/usage`),
};
