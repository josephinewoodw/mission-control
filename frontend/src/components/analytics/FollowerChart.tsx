...
export function FollowerChart({ snapshots, stats, posts, onJumpToPost }: FollowerChartProps) {
  ...
  return (
    <div className="space-y-5">
      {/* Stats sidebar + chart toggle */}
      <div className="flex items-start gap-6">
        {/* Velocity panel */}
        <div className="shrink-0 grid grid-cols-2 gap-3 min-w-[280px]">
